...
const Hero = () => {
  const handleDownload = () => {
    const fileName = "ArfaouiMaramResumeEnglish.pdf";
    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Maram</span>
          <span className="seq"> Arfaoui</span>
        </h1>
        <p>
          <span
            ref={typedEl}
        ...
        <div className="seq pt-4  flex flex-wrap gap-4">
          <Button href={`#${MENULINKS[4].ref}`} classes="link custom-button" type="primary">
            Let&apos;s Talk
          </Button>

          <Button   classes="link" type="primary" onClick={handleDownload}>
            Upload Resume
          </Button>
        </div>
      </div>
