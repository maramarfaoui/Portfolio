          ...
          <div className="flex flex-col skills-wrapper">
            <div className="flex flex-col">
              ...
              <h2 className="text-[1.65rem] font-medium md:max-w-lg w-full mt-2 seq">
                I take pride in developing cutting-edge solutions that marry form and function,
                ensuring a delightful user experience with a focus on sustainable development.{" "}
              </h2>
            </div>
            <div className="mt-10">
